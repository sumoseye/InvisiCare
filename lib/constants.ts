...
export const ZONES: Zone[] = [
  ...
  { id: 'kitchen', name: 'Kitchen', status: 'occupied', lastActivity: Date.now() - 120000, motionIntensity: 62, slug: 'kitchen', personIds: ['person-2'], occupancyCount: 1 },
...
export const ANALYTICS_PERSONS = ['all', 'person-1', 'person-2', 'person-3'] as const;
